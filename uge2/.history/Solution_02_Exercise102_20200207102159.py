...
if __name__ == "__main__":
    ...
    parser.add_argument("--exerciseC",  help="takes a list of filenames and print each line that contains an email (just look for @)")
    parser.add_argument("--exerciseC",  help="takes a list of md files and writes all headlines (lines starting with #) to a file Make sure your module can be called both from cli and imported to another module Create a new module that imports utils.py and test each function.")
