...
lst_ETCS = [10, 20, 30]
lst_imgurl = []
lst_courses = [Course(lst_course_names[random.randint(0,2)], lst_classrooms[random.randint(0,2)], lst_teachers[random.randint(0,2)], lst_ETCS[random.randint(0,2), lst_grades[random.randint(0,5)]])]
