...
lst_ETCS = [10, 20, 30]
lst_imgurl = []
lst_courses = [Course(random.choice(lst_course_names), random.choice(lst_classrooms), random.choice(lst_teachers), random.choice(lst_ETCS), random.choice(lst_grades) for n in range(10) ])]
