...
# lst_courses = [Course(rl(lst_course_names), rl(lst_classrooms), random.choice(lst_teachers), random.choice(lst_ETCS), random.choice(lst_grades)) for i in range(10)]
