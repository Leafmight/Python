...
def read_csv(input_file):
    if platform.system() == 'Windows':
        ...
        newline=None
    with open(input_file, newline=newline) as f:
        reader = csv.reader(f)
        my_list = list(reader)
    return my_list

def print_students(lst):
    for student in read_csv(lst):
        print(student.name, student.img_url, student.get_avg_grade())

if __name__ == "__main__":
    print("Hello in demo")
    print_students(generate_students(10))
